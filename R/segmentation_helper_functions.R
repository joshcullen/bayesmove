...
#'   animal ID and must include a column labeled \code{time1} that numbers each of
#'   the observations in consecutive order. This variable is automatically generated by
#'   the \code{\link{filter_time}} function during data preparation.
#' @param brkpts A data frame of breakpoints for each animal ID (as generated by
#'   \code{\link{get_breakpts}}).
#'
#' @return A data frame that updates the original data object by including the
