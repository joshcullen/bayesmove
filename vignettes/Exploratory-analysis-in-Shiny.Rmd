...
```{r load, message=FALSE, eval=TRUE, class.source = 'fold-show'}
library(bayesmove)
library(foieGras)
library(sf)
...
<br>
<br>
```{r eigth step, echo=FALSE}
## Need to add code to import screenshot
# knitr::include_graphics('Shiny-Fig8.png')

```
<p align="center">
<img src="Shiny-Fig8.png" width="600">
</p>
<br>
<br>
...
Jonsen I, Patterson T. (2020). foieGras: fit latent variable movement models to animal tracking data for location quality control and behavioural inference. *Zenodo*. [doi:10.5281/zenodo.3899972](https://doi.org/10.5281/zenodo.3899972)
